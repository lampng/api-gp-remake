...
router.get('/', (req, res) => {
    res.json({
        status: 'API ON',
        'Đăng ký(POST):': `http://api-gp-remake.onrender.com/user/register`,
        'Đăng nhập(POST):': `http://api-gp-remake.onrender.com/user/login`,
        'Đăng xuất(GET):': `http://api-gp-remake.onrender.com/user/logout/:id`,
        'Cập nhập người dùng(PUT):': `http://api-gp-remake.onrender.com/user/update/:id`,
        'Đổi mật khẩu(PUT):': `http://api-gp-remake.onrender.com/user/change-password/:id`,
        'Xoá người dùng(DELETE):': `http://api-gp-remake.onrender.com/user/delete/:id`,
        'Gọi danh sách người dùng(GET):': `http://api-gp-remake.onrender.com/user/list`,
        'Gọi chi tiết người dùng(GET):': `http://api-gp-remake.onrender.com/user/detail/:id`,
        'Thêm lương người dùng(POST):': `http://api-gp-remake.onrender.com/user/salary/:id`,
        'Gọi danh sách lương người dùng(GET):': `http://api-gp-remake.onrender.com/user/salary/:id`,
        'Cập nhập lương người dùng(PUT):': `http://api-gp-remake.onrender.com/user/salary/:id`,
        'Xoá lương người dùng(DELETE):': `http://api-gp-remake.onrender.com/user/salary/:id`,
        'Quên mật khẩu(GET):': `http://api-gp-remake.onrender.com/user/forgot-password/`,
        'Xác nhận mã được gửi về mail(POST):': `http://api-gp-remake.onrender.com/user/verify-confirmation-code/`,
        'Đặt lại mật khẩu mới(PUT):': `http://api-gp-remake.onrender.com/user/reset-password/`,
    });
});
