...
router.get('/', (req, res) => {
    res.json({
        ...
        'Đăng xuất(GET):': `http://localhost:1102/user/logout/:id`,
        'Cập nhập người dùng(PUT):': `http://localhost:1102/user/update/:id`,
        'Đổi mật khẩu(PUT):': `http://localhost:1102/user/change-password/:id`,
        'Xoá người dùng(DELETE):': `http://localhost:1102/user/delete/:id`,
        'Gọi danh sách người dùng(GET):': `http://localhost:1102/user/list`,
        'Gọi chi tiết người dùng(GET):': `http://localhost:1102/user/detail/:id`,
        'Thêm lương người dùng(POST):': `http://localhost:1102/user/salary/:id`,
        'Gọi danh sách lương người dùng(GET):': `http://localhost:1102/user/salary/:id`,
        'Cập nhập lương người dùng(PUT):': `http://localhost:1102/user/salary/:id`,
        'Xoá lương người dùng(DELETE):': `http://localhost:1102/user/salary/:id`,
        'Quên mật khẩu(GET):': `http://localhost:1102/user/forgot-password/`,
        'Xác nhận mã được gửi về mail(POST):': `http://localhost:1102/user/verify-confirmation-code/`,
        'Đặt lại mật khẩu mới(PUT):': `http://localhost:1102/user/reset-password/`,
    });
});
